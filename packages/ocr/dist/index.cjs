...
var lineItemSchema = zod.z.object({
  ...
  unit_price: zod.z.number().optional(),
  total: zod.z.number().optional()
});
var invoiceSchema = zod.z.object({
  total_amount: zod.z.number().nullable().optional(),
  currency: zod.z.string().nullable().optional(),
  vendor_name: zod.z.string().nullable().optional(),
  invoice_date: zod.z.string().nullable().optional(),
  due_date: zod.z.string().nullable().optional(),
  invoice_number: zod.z.string().nullable().optional(),
  customer_name: zod.z.string().nullable().optional(),
  vendor_address: zod.z.string().nullable().optional(),
  customer_address: zod.z.string().nullable().optional(),
  email: zod.z.string().nullable().optional(),
  website: zod.z.string().nullable().optional(),
  tax_amount: zod.z.number().nullable().optional(),
  tax_rate: zod.z.number().nullable().optional(),
  tax_type: zod.z.string().nullable().optional(),
  payment_instructions: zod.z.string().nullable().optional(),
  notes: zod.z.string().nullable().optional(),
  language: zod.z.string().nullable().optional(),
  line_items: zod.z.array(lineItemSchema).optional()
});
var receiptSchema = zod.z.object({
  ...
  payment_method: zod.z.string().nullable().optional(),
  items: zod.z.array(lineItemSchema).optional(),
  tax_amount: zod.z.number().nullable().optional(),
  tax_rate: zod.z.number().nullable().optional(),
  subtotal: zod.z.number().nullable().optional(),
  tip: zod.z.number().nullable().optional(),
  notes: zod.z.string().nullable().optional()
});
