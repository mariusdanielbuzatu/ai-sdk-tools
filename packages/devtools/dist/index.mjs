...
import { Handle, Position, MarkerType, useNodesState, useEdgesState, ReactFlow, Background } from '@xyflow/react';
import dagre from 'dagre';
import React2, { memo, useMemo, useEffect, useCallback, useState, useRef, useContext } from 'react';
import '@xyflow/react/dist/style.css';
import { Build, Schedule, Error as Error$1, CheckCircle, PlayArrow, Help, Pause, Clear, ViewSidebar, ViewList, Close, DataObject, ErrorOutline, Api, Settings, Psychology, Circle, Code, Send } from '@mui/icons-material';
import { jsxs, Fragment, jsx } from 'react/jsx-runtime';
import { ChatStoreContext as ChatStoreContext$1 } from '@ai-sdk-tools/store';
...
function AgentNodeComponent({ data }) {
  ...
  const getStatusIcon = () => {
    switch (status) {
      case "executing":
        return /* @__PURE__ */ jsx(PlayArrow, { sx: { fontSize: 16 } });
      case "completed":
        return /* @__PURE__ */ jsx(CheckCircle, { sx: { fontSize: 16 } });
      case "error":
        return /* @__PURE__ */ jsx(Error$1, { sx: { fontSize: 16 } });
      default:
        return /* @__PURE__ */ jsx(Schedule, { sx: { fontSize: 16 } });
    }
  };
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { style: { color: statusColor, display: "flex", fontSize: 14 }, children: getStatusIcon() })
              ]
            }
          ),
          /* @__PURE__ */ jsx(
          ...
          duration !== void 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { style: { color: "#71717a" }, children: "Duration" }),
                  /* @__PURE__ */ jsxs("span", { style: { color: "#f4f4f5", fontWeight: 500 }, children: [
                    duration.toFixed(2),
                    "s"
                  ] })
                ]
...
var AgentNode = memo(AgentNodeComponent);
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { style: { color: "#f59e0b", display: "flex", fontSize: 14 }, children: /* @__PURE__ */ jsx(Build, { sx: { fontSize: 16 } }) })
              ]
            }
          ),
...
var ToolNode = memo(ToolNodeComponent);
var nodeTypes = {
  agentNode: AgentNode,
  toolNode: ToolNode
};
...
function AgentFlowVisualization({
  ...
  if (agentFlowData.nodes.length === 0) {
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-state-explorer-empty-content", children: [
          /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-explorer-empty-title", children: "No Agent Activity" }),
          /* @__PURE__ */ jsxs("div", { className: "ai-devtools-state-explorer-empty-description", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { style: { height: "100%", width: "100%", background: "#000000" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { height: "100%", width: "100%", position: "relative" }, children: [
      /* @__PURE__ */ jsx(
        ReactFlow,
        {
          nodes,
      ...
      /* @__PURE__ */ jsx("div", { style: {
        ...
        fontSize: "10px",
        color: "#cccccc"
      }, children: /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: "16px", alignItems: "center" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "4px" }, children: [
          /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, color: "#ffffff" }, children: agentFlowData.nodes.length }),
          /* @__PURE__ */ jsx("span", { style: { color: "#666666" }, children: "Agents" })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "4px" }, children: [
          /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, color: "#ffffff" }, children: agentFlowData.handoffs.length }),
          /* @__PURE__ */ jsx("span", { style: { color: "#666666" }, children: "Handoffs" })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "4px" }, children: [
          /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, color: "#ffffff" }, children: agentFlowData.totalRounds }),
          /* @__PURE__ */ jsx("span", { style: { color: "#666666" }, children: "Rounds" })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "4px" }, children: [
          /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, color: "#ffffff" }, children: agentFlowData.totalDuration > 0 ? `${(agentFlowData.totalDuration / 1e3).toFixed(2)}s` : "0s" }),
          /* @__PURE__ */ jsx("span", { style: { color: "#666666" }, children: "Duration" })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx("style", { children: `
...
function useAIDevtools(options = {}) {
  ...
  const streamInterceptor = useRef(null);
  const debugLog = createDebugLogger(debug);
  const throttleQueue = useRef([]);
  const throttleTimer = useRef(null);
  const lastEventTimes = useRef(/* @__PURE__ */ new Map());
    ...
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("title", { children: "AI SDK Tools Logo" }),
            /* @__PURE__ */ jsx("path", { fill: "url(#a)", d: "m22 .5 16 52L31 83H0L22 .5Z" }),
            /* @__PURE__ */ jsx("path", { fill: "#D9D9D9", d: "M62 .5H30l13 41.25L56 83h31L62 .5Z" }),
            /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs(
              "linearGradient",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("stop", { offset: 1, stopColor: "#D9D9D9" })
                ]
              }
            ) })
          ]
...
var ChatStoreContext = ChatStoreContext$1;
function useCurrentState(options = {}) {
  ...
  const DummyContext = useRef(
    React2.createContext(void 0)
  ).current;
  const contextToUse = ChatStoreContext || DummyContext;
  const storeApi = useContext(contextToUse);
...
function getEventTypeIcon(type) {
  const icons = {
    ...
    "tool-call-start": /* @__PURE__ */ jsx(Build, { sx: { fontSize: "0.75rem" } }),
    "tool-call-result": /* @__PURE__ */ jsx(CheckCircle, { sx: { fontSize: "0.75rem" } }),
    "tool-call-error": /* @__PURE__ */ jsx(ErrorOutline, { sx: { fontSize: "0.75rem" } }),
    // Messages - using Send/Message icons
    "message-start": /* @__PURE__ */ jsx(Send, { sx: { fontSize: "0.75rem" } }),
    "message-chunk": /* @__PURE__ */ jsx(Circle, { sx: { fontSize: "0.4rem" } }),
    "message-complete": /* @__PURE__ */ jsx(CheckCircle, { sx: { fontSize: "0.75rem" } }),
    // Text events - using Code/TextFields icons
    "text-start": /* @__PURE__ */ jsx(Code, { sx: { fontSize: "0.75rem" } }),
    "text-delta": /* @__PURE__ */ jsx(Circle, { sx: { fontSize: "0.4rem" } }),
    "text-end": /* @__PURE__ */ jsx(Code, { sx: { fontSize: "0.75rem" } }),
    // Reasoning events - using Psychology icon
    "reasoning-start": /* @__PURE__ */ jsx(Psychology, { sx: { fontSize: "0.75rem" } }),
    "reasoning-delta": /* @__PURE__ */ jsx(Circle, { sx: { fontSize: "0.4rem" } }),
    "reasoning-end": /* @__PURE__ */ jsx(Psychology, { sx: { fontSize: "0.75rem" } }),
    // Steps - using Settings/PlayArrow for process steps
    "start-step": /* @__PURE__ */ jsx(Settings, { sx: { fontSize: "0.75rem" } }),
    "finish-step": /* @__PURE__ */ jsx(CheckCircle, { sx: { fontSize: "0.75rem" } }),
    // Stream events - using Api/Done icons
    "start": /* @__PURE__ */ jsx(Api, { sx: { fontSize: "0.75rem" } }),
    finish: /* @__PURE__ */ jsx(Api, { sx: { fontSize: "0.75rem" } }),
    "stream-done": /* @__PURE__ */ jsx(Api, { sx: { fontSize: "0.75rem" } }),
    // Error and data events
    error: /* @__PURE__ */ jsx(ErrorOutline, { sx: { fontSize: "0.75rem" } }),
    "custom-data": /* @__PURE__ */ jsx(DataObject, { sx: { fontSize: "0.75rem" } }),
    unknown: /* @__PURE__ */ jsx(Help, { sx: { fontSize: "0.75rem" } })
  };
  return icons[type] || /* @__PURE__ */ jsx(Help, { sx: { fontSize: "0.75rem" } });
}
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-content", children: [
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-indicator", title: event.type }),
                /* @__PURE__ */ jsx("span", { className: "ai-devtools-event-icon", children: typeIcon }),
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-description", children: /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-text", children: description }) })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-timestamp", children: formatTimestamp(event.timestamp) }),
              /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-expand", children: /* @__PURE__ */ jsx(
                "svg",
                {
        ...
        isExpanded && /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-expanded", children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-details", children: [
          /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-metadata", children: [
            /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-metadata-title", children: "Event Details" }),
            /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-metadata-grid", children: [
              /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-metadata-item", children: [
                /* @__PURE__ */ jsx("span", { className: "ai-devtools-event-metadata-label", children: "ID:" }),
                " ",
                event.id
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-metadata-item", children: [
                /* @__PURE__ */ jsx("span", { className: "ai-devtools-event-metadata-label", children: "Type:" }),
                " ",
                event.type
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-metadata-item", children: [
                /* @__PURE__ */ jsx("span", { className: "ai-devtools-event-metadata-label", children: "Timestamp:" }),
                " ",
                new Date(event.timestamp).toISOString()
              ] }),
              event.metadata?.messageId && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-metadata-item", children: [
                /* @__PURE__ */ jsx("span", { className: "ai-devtools-event-metadata-label", children: "Message ID:" }),
                " ",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-data-title", children: "Data" }),
            /* @__PURE__ */ jsx("pre", { className: "ai-devtools-event-data-content", children: formatEventData(event) })
          ] }),
          event.metadata && Object.keys(event.metadata).length > 0 && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-event-metadata-section", children: [
            /* @__PURE__ */ jsx("div", { className: "ai-devtools-event-metadata-title", children: "Metadata" }),
            /* @__PURE__ */ jsx("pre", { className: "ai-devtools-event-metadata-content", children: JSON.stringify(event.metadata, null, 2) })
          ] })
        ] }) })
      ]
    }
...
function Tooltip({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "ai-devtools-tooltip-container", children: [
    children,
    /* @__PURE__ */ jsx("div", { className: "ai-devtools-tooltip", children: content })
  ] });
}
      ...
      children: [
        /* @__PURE__ */ jsx(
          Tooltip,
          {
            ...
            content: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-tooltip-content", children: [
              /* @__PURE__ */ jsx("div", { className: "ai-devtools-tooltip-title", children: "Tool Parameters" }),
              /* @__PURE__ */ jsx("pre", { className: "ai-devtools-tooltip-params", children: formatToolParams(toolParams) })
            ] }),
            children: /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "ai-devtools-session-content", children: [
                    /* @__PURE__ */ jsx(
                      "div",
                      {
                    ...
                    /* @__PURE__ */ jsx("span", { className: "ai-devtools-session-icon", children: statusIcon }),
                    /* @__PURE__ */ jsxs("div", { className: "ai-devtools-session-info", children: [
                      /* @__PURE__ */ jsxs("div", { className: "ai-devtools-session-tool-name", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "ai-devtools-session-summary", children: summary })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "ai-devtools-session-timestamp", children: formatTimestamp(session.startTime) }),
                  /* @__PURE__ */ jsx("div", { className: "ai-devtools-session-expand", children: /* @__PURE__ */ jsx(
                    "svg",
                    {
        ...
        isExpanded && /* @__PURE__ */ jsx("div", { className: "ai-devtools-session-events", children: session.events.map((event) => /* @__PURE__ */ jsx(
          EventItem,
          {
            event,
...
function EventList({
  ...
  if (events.length === 0) {
    return /* @__PURE__ */ jsx("div", { className: `ai-devtools-empty-state ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-empty-content", children: [
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-empty-title", children: "\u25B8 waiting for events..." }),
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-empty-subtitle", children: "start streaming to capture events" })
    ] }) });
  }
  if (!groupByToolCalls) {
    return /* @__PURE__ */ jsx("div", { className: `ai-devtools-event-list ${className}`, children: events.slice().reverse().map((event) => /* @__PURE__ */ jsx(EventItem, { event }, event.id)) });
  }
  const { sessions, standaloneEvents } = groupEventsIntoSessions(events);
  return /* @__PURE__ */ jsxs("div", { className: `ai-devtools-event-list ${className}`, children: [
    sessions.slice().reverse().map((session) => /* @__PURE__ */ jsx(
    ...
    standaloneEvents.slice().reverse().map((event) => /* @__PURE__ */ jsx(EventItem, { event }, `event-${event.id}`))
  ] });
}
function StateDataExplorer({
  ...
  if (!displayData) {
    return /* @__PURE__ */ jsx("div", { className: `ai-devtools-state-explorer-empty ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-state-explorer-empty-content", children: [
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-explorer-empty-icon", children: "\u26A1" }),
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-explorer-empty-title", children: "No State Data" }),
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-explorer-empty-description", children: "Select a store to view its current state" })
    ] }) });
  }
  return /* @__PURE__ */ jsx("div", { className: `ai-devtools-state-explorer ${className}`, children: /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-explorer-content", children: /* @__PURE__ */ jsx(
    JsonView,
    {
      data: displayData,
      style: {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ai-devtools-header", children: [
          /* @__PURE__ */ jsxs("div", { className: "ai-devtools-search-bar", children: [
            /* @__PURE__ */ jsxs("div", { className: "ai-devtools-search-input-container", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
              ...
              (filters.types.length > 0 || filters.toolNames.length > 0) && /* @__PURE__ */ jsx("div", { className: "ai-devtools-filter-indicator", children: /* @__PURE__ */ jsx("span", { className: "ai-devtools-filter-indicator-count", children: filters.types.length + filters.toolNames.length }) })
            ] }),
            showSearchSuggestions && /* @__PURE__ */ jsx("div", { className: "ai-devtools-search-suggestions", children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-search-suggestions-content", children: [
              filteredSuggestions.eventTypes.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-suggestion-section", children: [
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-suggestion-section-title", children: "Event Types" }),
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-suggestion-options", children: filteredSuggestions.eventTypes.map((type) => {
                  ...
                  return /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("span", { className: "ai-devtools-suggestion-icon", children: getEventTypeIcon(type) }),
                        /* @__PURE__ */ jsx("span", { className: "ai-devtools-suggestion-label", children: EVENT_TYPE_LABELS[type] }),
                        /* @__PURE__ */ jsx("span", { className: "ai-devtools-suggestion-count", children: eventCounts[type] || 0 })
                      ]
                    },
                    type
                  );
              ...
              filteredSuggestions.tools.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-suggestion-section", children: [
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-suggestion-section-title", children: "Tools" }),
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-suggestion-options", children: filteredSuggestions.tools.map((toolName) => {
                  ...
                  return /* @__PURE__ */ jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("span", { className: "ai-devtools-suggestion-icon", children: "\u{1F527}" }),
                        /* @__PURE__ */ jsx("span", { className: "ai-devtools-suggestion-label", children: formatToolName(toolName) })
                      ]
                    },
                    toolName
                  );
              ...
              filteredSuggestions.quickSearches.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-suggestion-section", children: [
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-suggestion-section-title", children: "Quick Search" }),
                /* @__PURE__ */ jsx("div", { className: "ai-devtools-suggestion-options", children: filteredSuggestions.quickSearches.map((term) => /* @__PURE__ */ jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      /* @__PURE__ */ jsx("span", { className: "ai-devtools-suggestion-icon", children: term === "error" ? "!" : term === "tool" ? "\u25B6" : "T" }),
                      /* @__PURE__ */ jsx("span", { className: "ai-devtools-suggestion-label", children: term })
                    ]
                  },
                  term
                )) })
          ...
          /* @__PURE__ */ jsxs("div", { className: "ai-devtools-header-right", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  isCapturing ? /* @__PURE__ */ jsx(Pause, { className: "ai-devtools-btn-icon" }) : /* @__PURE__ */ jsx(PlayArrow, { className: "ai-devtools-btn-icon" }),
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(Clear, { className: "ai-devtools-btn-icon" }),
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: config.position === "bottom" ? /* @__PURE__ */ jsx(ViewSidebar, { className: "ai-devtools-position-toggle-icon" }) : /* @__PURE__ */ jsx(ViewList, { className: "ai-devtools-position-toggle-icon" })
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx(Close, { className: "ai-devtools-close-icon" })
              }
            )
          ] })
        ] }),
        showFilters && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-filter-badges", children: [
          filters.types.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-filter-group", children: [
            /* @__PURE__ */ jsx("span", { className: "ai-devtools-filter-group-label", children: "Types:" }),
            filters.types.map((type) => /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  type.replace(/-/g, " "),
                  /* @__PURE__ */ jsx("span", { className: "ai-devtools-filter-remove", children: "\xD7" })
                ]
              },
              type
            ))
          ] }),
          filters.toolNames.length > 0 && /* @__PURE__ */ jsxs("div", { className: "ai-devtools-filter-group", children: [
            /* @__PURE__ */ jsx("span", { className: "ai-devtools-filter-group-label", children: "Tools:" }),
            filters.toolNames.map((toolName) => /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
                className: "ai-devtools-filter-badge active",
          ...
          /* @__PURE__ */ jsxs("div", { className: "ai-devtools-filter-group", children: [
            /* @__PURE__ */ jsx("span", { className: "ai-devtools-filter-group-label", children: "Quick:" }),
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsx("div", { className: "ai-devtools-panel-content", children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-content", children: [
          activeTab === "events" && /* @__PURE__ */ jsx("div", { className: "ai-devtools-events", children: /* @__PURE__ */ jsx(EventList, { events: filteredEvents }) }),
          activeTab === "agents" && /* @__PURE__ */ jsx(AgentFlowVisualization, { events }),
          activeTab === "state" && isStoreAvailable && /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-panel-full", children: /* @__PURE__ */ jsx(
            StateDataExplorer,
            {
        ...
        /* @__PURE__ */ jsx("div", { className: "ai-devtools-bottom-stats", children: /* @__PURE__ */ jsx("div", { className: "ai-devtools-tokens-section", children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-speed-metrics", children: [
          /* @__PURE__ */ jsxs("div", { className: "ai-devtools-speed-metric", children: [
            /* @__PURE__ */ jsx("span", { className: "ai-devtools-speed-value", children: streamingSpeed.tokensPerSecond }),
            /* @__PURE__ */ jsx("span", { className: "ai-devtools-speed-label", children: "tok/s" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "ai-devtools-speed-metric", children: [
            /* @__PURE__ */ jsx("span", { className: "ai-devtools-speed-value", children: streamingSpeed.charactersPerSecond }),
            /* @__PURE__ */ jsx("span", { className: "ai-devtools-speed-label", children: "char/s" })
          ] })
        ] }) }) })
      ]
    }
...
function AIDevtools({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "ai-devtools", children: [
    /* @__PURE__ */ jsx(
      DevtoolsButton,
      {
...
function StoreList({
  ...
  if (storeIds.length === 0) {
    return /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-changes-empty", children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-state-changes-empty-content", children: [
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-changes-empty-icon", children: "\u{1F4CA}" }),
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-changes-empty-title", children: "No Stores Found" }),
      /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-changes-empty-description", children: "Ensure you are using `@ai-sdk-tools/store` in your application." })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: "ai-devtools-state-changes-list", children: [
    /* @__PURE__ */ jsxs("div", { className: "ai-devtools-state-changes-header", children: [
      /* @__PURE__ */ jsx("h3", { children: "Available Stores" }),
      /* @__PURE__ */ jsxs("span", { className: "ai-devtools-state-changes-count", children: [
        storeIds.length,
        " store",
        storeIds.length !== 1 ? "s" : ""
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-changes-items", children: storeIds.map((storeId) => /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        ...
        children: /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-change-item-content", children: /* @__PURE__ */ jsxs("div", { className: "ai-devtools-state-change-item-header", children: [
          /* @__PURE__ */ jsx("div", { className: "ai-devtools-state-change-type", children: /* @__PURE__ */ jsx("span", { className: "ai-devtools-state-change-type-label", children: storeId === "default" ? "Default" : storeId }) }),
          /* @__PURE__ */ jsx("span", { className: "ai-devtools-state-change-timestamp", children: "Store" })
        ] }) })
      },
      storeId
    )) })
...
export { AIDevtools, AgentFlowVisualization, AgentNode, DevtoolsButton, DevtoolsPanel, EventItem, EventList, StateDataExplorer, StoreList, StreamInterceptor, ToolNode, createDebugLogger, formatEventData, formatTimestamp, getEventDescription, getEventTypeColor, getEventTypeIcon, getSessionStatusColor, getSessionStatusIcon, getSessionSummary, groupEventsIntoSessions, isStorePackageAvailable, parseEventFromDataPart, parseSSEEvent, useAIDevtools, useCurrentState };
